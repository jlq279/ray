...
void GraphicalUI::cb_3dSlides(Fl_Widget* o, void* v)
{
	pUI=(GraphicalUI*)(o->user_data());
...
void GraphicalUI::cb_3dCheckButton(Fl_Widget* o, void* v)
{
	pUI=(GraphicalUI*)(o->user_data());
	pUI->m_3d = (((Fl_Check_Button*)o)->value() == 1);
	if (pUI->m_3d) 
	{
		pUI->m_3dSlider->activate();
	}
	else
	{
		pUI->m_3dSlider->deactivate();
	}
}
...
void GraphicalUI::cb_aaCheckButton(Fl_Widget* o, void* v)
{
	...
	if (pUI->m_antiAlias) 
	{
		...
		pUI->m_assAACheckButton->activate();
	}
	else
	{
		pUI->m_aaSamplesSlider->deactivate();
		pUI->m_aaThreshSlider->deactivate();
		pUI->m_assAACheckButton->deactivate();
	}
}

void GraphicalUI::cb_assAACheckButton(Fl_Widget* o, void* v)
{
	pUI = (GraphicalUI*)(o->user_data());
	pUI->m_assAA = (((Fl_Check_Button*)o)->value() == 1);
}
...
GraphicalUI::GraphicalUI() : refreshInterval(10) {
	...
	m_pathSamplesSlider->minimum(16);
	m_pathSamplesSlider->maximum(256);
	m_pathSamplesSlider->step(16);
	...
	m_lightSamplesSlider->minimum(16);
	m_lightSamplesSlider->maximum(256);
	m_lightSamplesSlider->step(16);
	m_lightSamplesSlider->value(m_nPathSamples);
	...
	m_3dSlider->labelsize(12);
	m_3dSlider->minimum(0);
	m_3dSlider->maximum(20);
	m_3dSlider->step(0.1);
	m_3dSlider->value(m_n3dOffset);
	m_3dSlider->align(FL_ALIGN_RIGHT);
	m_3dSlider->callback(cb_3dSlides);
